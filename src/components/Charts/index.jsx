  ...
  return (
    ...
    <Card
      ...
      >
        ...
        >
          <div style={{color:"green",fontSize:"40px",textAlign:"justify"}}>Total</div>
        </div>
      ...
      >
        ...
        <div
          ...
          // style={{ backgroundImage: `url(images.jpeg)` }}
        >
          <div style={{color:"green",fontSize:"40px",textAlign:"justify"}}>Resolved</div>
        </div>
      ...
      >
        ...
        <div
          ...
          // style={{ backgroundImage: `url(images.jpeg)` }}
        >
          <div style={{color:"green",fontSize:"40px",textAlign:"justify"}}>Pending</div>
        </div>
